...
# model = RobertaForMaskedLM.from_pretrained('/app/sup-simcse-roberta-large/pytorch_model.bin', from_tf=True)
...
class BaseLLM():
    def __init__(self, model_name: Optional[str] = None, model_path: Optional[str] = None) -> None:
        ...
        Rule: Your answer should be from the provided list as in the following examples 
            ...
            2 - bring me food; 
                Answer: Find an object by classhuggingface_hub.utils._validators.HFValidationError: Repo id must be in the form 'repo_name' or 'namespace/repo_name': '/app/sup-simcse-roberta-large/pytorch_model.bin'. Use `repo_type` argument if needed.
