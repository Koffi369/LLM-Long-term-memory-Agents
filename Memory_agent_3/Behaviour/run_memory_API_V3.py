...
class BaseLLM():
    def __init__(self, model_name: Optional[str] = None, model_path: Optional[str] = None) -> None:
        ...
        Now provide your answer:
            """
        self.behaviour_intro = """
        I will give you  a list of tasks and their behavior patterns. 
        When a user gives you  a task, your goal will be to identify the behavior pattern associated with that task from the provided list.
